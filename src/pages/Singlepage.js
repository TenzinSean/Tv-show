            ...
            {loading ? <h2>Loading....</h2> : 
                <div className="singleshow">
                    <img src={singleShow.image ? singleShow.image.medium :  
                        "https://www.publicdomainpictures.net/pictures/280000/velka/not-found-image-15383864787lu.jpg"} alt={singleShow.name}/>
                <div className="singleshow__info">
                    ...
                    <p>
                        <strong>Official Site: </strong> {singleShow.officalSite ? (<a href={singleShow.officalSite} target="_blank" rel="noreferrer">
